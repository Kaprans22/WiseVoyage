class TripsController < ApplicationController
  ...
  def show
    ...
    if @trip.additional_suggestions.nil? || @trip.additional_suggestions.empty?
      additional_suggestions = get_additional_suggestions(@trip.destination, @trip.start_date, @trip.end_date, false)
      @trip.update_attribute(:additional_suggestions, additional_suggestions[@trip.destination.strip]) if additional_suggestions[@trip.destination.strip]
    end
  end
  def destroy_all
